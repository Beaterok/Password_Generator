...
var generatePassword = function () {
 ...
 //it is saying if user input is below 8 OR above 128 then to return null(nothing)
...
// set up if else statement for each possible scenario for user inputs
// Make the solution as a variable at the end(run the function at the end)
// you need to call the answer into the HTML
// pick a random number to select a random character from each array(use .length instead of
//inputting how many items are in the array)
